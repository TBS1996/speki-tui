...
expected gain cookbok! :D


we should have a pure function, that takes in 3 cards

the normal card
the card with a new successful review
the card with a new failed review

at a certain point in time

the reviews being added should be the same time as  when it's checked or something
...
fn view_card_info(stdout: &mut Stdout, card: Arc<SavedCard>) {
